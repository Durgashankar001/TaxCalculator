                        ...
                        <>
                            ...
                            >
                                {acceptedFile ? (
                                    ...
                                    <p className='upload_btn'>Click to upload <IconContext.Provider value={{ className: 'react-icons' }}> <BsFillArrowUpCircleFill size={20} color={"white"}/></IconContext.Provider> </p>
                                )}
                            </div>
